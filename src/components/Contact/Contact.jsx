...
const handleSubmit = useCallback(async (e) => {
  ...
  try {
    await emailjs.send(
      "service_gqcm72q",   // your service ID
      "template_bq6p5z7",  // your template ID
      {
      ...
      "ioP9-tIzIjSSuGTiF"      // your emailJS public key
    );

    addToast("success", "Message sent successfully! I will respond soon.");
  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      label: "Email",
      value: "snehasiskoley95@gmail.com",
      href: "mailto:snehasiskoley95@gmail.com",
      color: "text-blue-400"
    },
    {
      icon: FaPhone,
    ...
    },
    {
      icon: FaMapMarkerAlt,
      label: "Location",
      value: "Patratu, Ranchi, Jharkhand",
        ...
        <div className="container mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Looking for a passionate Full Stack Developer intern? Let's build something amazing together.
            </p>
          </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200"
                        placeholder="snehasiskoley95@gmail.com"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200"
                      placeholder="regarding internship opportunity"
                    />
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 shadow-2xl">
                ...
                <div className="p-6 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    ...
                    Ready to contribute with Nextjs and Nodejs expertise.
                  </p>
                </div>
              </div>
            </motion.div>
